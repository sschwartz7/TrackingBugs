...
namespace TrackingBugs.Data
{
    ...
    public static class DataUtility
    {
        ...
        public static async Task SeedDemoUsersAsync(UserManager<BTUser> userManager, IConfiguration configuration)
        {
            string? demoAdminEmail = configuration["DemoAdminEmail"] ?? Environment.GetEnvironmentVariable("DemoAdminEmail");
            string? demoPassword = configuration["DemoPassword"] ?? Environment.GetEnvironmentVariable("DemoPassword");
            ...
            string? demoPMEmail = configuration["DemoPMEmail"] ?? Environment.GetEnvironmentVariable("DemoPMEmail");


            //Seed Demo ProjectManager User
            defaultUser = new BTUser
            {
                UserName = demoPMEmail,
                Email = demoPMEmail,
                FirstName = "Demo",
            ...
            string? demoDevEmail = configuration["DemoDevEmail"] ?? Environment.GetEnvironmentVariable("DemoDevEmail");
            ...
            string? demoSubEmail = configuration["DemoSubEmail"] ?? Environment.GetEnvironmentVariable("DemoSubEmail");
