...
namespace TrackingBugs.Controllers
{
    ...
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Created,Comment,UserId,TicketId")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Created,Comment,UserId,TicketId")] TicketComment ticketComment)
        {
