...
namespace TrackingBugs.Controllers
{
    public class HomeController : BTBaseController
    {
		...
		public HomeController(ILogger<HomeController> logger, UserManager<BTUser> userManager, ApplicationDbContext context, IProjectService projectService, IBTRoleService roleService, IBTTicketService ticketService, IBTCompanyService companyService)
		{
			_logger = logger;
